...
class Dropdown(ui.Select):
    callbackFunc: Incomplete
    owner: Incomplete
    def __init__(self, callback: Incomplete | None = ..., owner: Incomplete | None = ..., **kwargs) -> None: ...
    async def callback(self, interaction: discord.Interaction): ...
    async def defaultCallback(self, interaction: discord.Interaction, values: list[str]): ...

class DropdownView(ui.View):
    def __init__(self, callback: Incomplete | None = ..., owner: Incomplete | None = ..., **kwargs) -> None: ...
    def add_dropdown(self, callback: Incomplete | None = ..., owner: Incomplete | None = ..., **kwargs) -> None: ...
