...
class Pages(discord.ui.View):
    ...
    def __init__(self, source: menus.PageSource, *, ctx: commands.Context, check_embeds: bool = ..., compact: bool = ...) -> None: ...
    def fill_items(self) -> None: ...
    async def show_page(self, interaction: discord.Interaction, page_number: int) -> None: ...
    async def show_checked_page(self, interaction: discord.Interaction, page_number: int) -> None: ...
    async def interaction_check(self, interaction: discord.Interaction) -> bool: ...
    async def on_timeout(self) -> None: ...
    async def on_error(self, interaction: discord.Interaction, exception: Exception, item: Any) -> None: ...
...
class TextPageSource(menus.ListPageSource):
    def __init__(self, text, *, prefix: str = ..., suffix: str = ..., max_size: int = ...) -> None: ...
...
class SimplePages(Pages):
    embed: Incomplete
    def __init__(self, entries, *, ctx: commands.Context, per_page: int = ...) -> None: ...
